...
adtl A LIST containing CuePoint annotation chunks. 
...
info A LIST containing text chunks: 
...
See wavrw's sibling project WavRef for more information about chunks:
